...
<View className="flex-row items-center justify-between mb-5">
  ...
  <TouchableOpacity className="items-center justify-center bg-[#C7C8FF] w-32 h-32 rounded-lg ml-1 mr-1">
    <Text className="text-base text-black text-center">I want to brush teeth</Text>
  </TouchableOpacity>
  <TouchableOpacity className="items-center justify-center bg-[#FF6347] w-32 h-32 rounded-lg ml-1">
    <Text className="text-base text-black text-center">I want to brush teeth</Text>
  </TouchableOpacity>
</View>
